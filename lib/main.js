...
async function bootstrap(args) {
  ...
  envConfig.createDbSync("databases", path.join(__app.config.systemDbPath, "databases.json"));
  envConfig.createDbSync("projects", path.join(__app.config.systemDbPath, "projects.json"));
