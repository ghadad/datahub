...
exports = module.exports = class {
    ...
    async collect(flow, flowBulkUpsert) {
        await this.reader.init();
        let collectorStatus = await this.reader.collect(flow, flowBulkUpsert).catch(e => __app.logger.error(e));
        __app.logger.info("collectorStatus:", collectorStatus)
    }
