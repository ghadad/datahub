...
exports = module.exports = class Interface {
  ...
  async exec() {
    ...
    await self.build();
    const mailOptions = {
      from: 'ghadad@gmail.com', // sender address
      to: 'ghadad@gmail.com', // list of receivers
      subject: 'Subject of your email', // Subject line
      html: '<p>Your html here</p>' // plain text body
    };
    console.log(__app.secureConf)
  ...
  async build() {
    ...
    let rows = await this.getInterfaceResult();
