 ...
 exports = module.exports = class {
   constructor(interfaceConfig) {
     this.config = interfaceConfig.notifications;
   ...
   isActive(type) {
     return __app.lodash.get(this.config, type + ".active", false)
   }
   ...
   async send(result) {
     ...
     if (result.type == "failure") {
       ...
       attachment = await this.producer.getAttachment("csv", result.errors, {
         filename: `${this.interface.interfaceName}.interface.${__app.ts("timestamp")}.exceptions.csv`
