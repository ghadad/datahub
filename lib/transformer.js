 ...
 class Transformer {
    ...
    init() {
        this.functions.customFunction = {
            params: [{label:"Handler return new Value" ,type:'code'}],
            desc: "custom handler that retreive new value."
        };
        this.functions.round = {
            func: lodash.round,
            params: [{label:"precision",type:'number'}],
        ...
        this.functions.replace = {
            func: lodash.replace,
            params: [{label:"what",type:'text'},{label:"replacement",type: 'text'}],
        ...
        this.functions.inRange = {
            func: lodash.inRange,
            params: [{label:"Start",type:'number'},{label:"End",type:'number'}],
        ...
        this.functions.substr = {
            func: this.substr,
            params: [{label:"From char",type:'number'},{label:"Length",type:'number',optional:true}],
            desc: "substring string"
        };
        this.functions.dateFormat = {
            func: this.dateFormat,
            params: [{label:"Date format",type:'text'}],
            desc: "date format"
        };
    }
