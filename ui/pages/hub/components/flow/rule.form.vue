<template>
  <div>
    <h1>Mapping/Validation/Drop rule</h1>
    <div class="columns">
      <div class="column is-4">
        <div class="field">
          <label class="label">Target property</label>
          <div class="control">
            <input class="input" type="text" placeholder="go to" v-model="value.goTo" pattern="/\w+/" />
          </div>
        </div>
      </div>
     ...
     <div class="columns">
      ...
      URL(RESTAPI)
         <div class="field">
          <div class="control">
            <input class="input" type="text" placeholder="url" v-model="value.restapi" pattern="/\w+/" />
          </div>
        </div>
       </div>
    </div>
    ...
    <div class="columns">
      ...
      <div class="column is-8">
        {{activeValdation.desc}}
      </div>
      <div class="column is-2">
        {{activeValdation.params}}        <button>Add to pipeline</button>
    ...
    <div class="columns">
      ...
      <div class="column is-8">
        {{activeTransformation.desc}}
      </div>
      <div class="column is-2">
        {{activeTransformation.params}}        <button>Add to pipeline</button>
